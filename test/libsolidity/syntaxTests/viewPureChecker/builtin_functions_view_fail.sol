...
// ----
// Warning 9207: (52-74): 'transfer' is deprecated and scheduled for removal in the next breaking version (0.9). Use 'call{value: <amount>}()' instead.
// Warning 9207: (132-150): 'send' is deprecated and scheduled for removal in the next breaking version (0.9). Use 'call{value: <amount>}()' instead.
